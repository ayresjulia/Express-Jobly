...
describe("POST /companies -> create a new company", () => {
	...
	test("OK to create for users", async () => {
...
describe("GET /companies -> get a list of companies", () => {
...
describe("GET /companies/:handle -> get company by handle", () => {
...
describe("PATCH /companies/:handle -> update company data", () => {
	...
	test("unauth for NOT admin", async () => {
...
describe("DELETE /companies/:handle -> delete a company by handle", () => {
	test("works for users", async () => {
