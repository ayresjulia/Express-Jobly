...
describe("POST /users", function () {
	test("works for only admin: create non-admin", async function () {
	...
	test("works for only admin: create admin", async function () {
		const resp = await request(app)
			.post("/users")
			.send({
				username: "u-new",
...
describe("GET /users", function () {
	test("works for only admins", async function () {
